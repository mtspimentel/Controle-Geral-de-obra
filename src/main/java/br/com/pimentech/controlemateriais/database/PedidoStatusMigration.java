...
public final class PedidoStatusMigration implements Migration {

    @Override public int version() { return 4; }

    @Override public String description() { return "Status simplificados do pedido"; }

    @Override public boolean requiresForeignKeysOff() { return true; }

    @Override
    public void apply(Connection connection) throws SQLException {
        try (Statement statement = connection.createStatement()) {
            statement.executeUpdate("""
                    CREATE TABLE pedidos_status_new (
                    ...
                    """);
            statement.executeUpdate("INSERT INTO pedidos_status_new SELECT * FROM pedidos");
            statement.executeUpdate("DROP TABLE pedidos");
            statement.executeUpdate("ALTER TABLE pedidos_status_new RENAME TO pedidos");
